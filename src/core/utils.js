 ...
 * @return {Number}     positive number in range of min
 *                      to max and maybe equal lower
 */
 ...
 * @param  {String} id             id that will be given to the new element
 * @param  {String} className      class that will be given to the new element
 * @param  {Object} styles         styles that will be applied to the element
